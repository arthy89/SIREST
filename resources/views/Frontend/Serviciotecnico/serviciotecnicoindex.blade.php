                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane show sort-layout-single active" id="layout-4-grid">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                                            <img src="{{ asset('assetsc/images/product/default/home-2/default-1.jpg') }}" alt="">
                                                            <img src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}" alt="">
                                            ...
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden aos-init" data-aos="fade-up" data-aos-delay="600">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                                            <img src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}" alt="">
                                                            <img src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}" alt="">
