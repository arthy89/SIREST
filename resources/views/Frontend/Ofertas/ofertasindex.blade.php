                                        ...
                                        <div class="row">
                                            <div class="col-xl-3 col-lg-4 col-sm-6 col-12">
                                                ...
                                                <div class="product-default-single-item product-color--golden aos-init aos-animate" data-aos="fade-up" data-aos-delay="0">
                                                    <div class="image-box">
                                                        <a href="{{ route('detalles_oferta', $productos[0]->nombre_p) }}" class="image-link">
                                                ...
                                                <div class="product-list-single product-color--golden">
                                                    ...
                                                    <div class="product-list-content">
                                                        ...
                                                        <div class="product-action-icon-link-list">
                                                            <a href="#" data-bs-toggle="modal" data-bs-target="#modalAddcart" class="btn btn-lg btn-black-default-hover">Agregar Carrito</a>
