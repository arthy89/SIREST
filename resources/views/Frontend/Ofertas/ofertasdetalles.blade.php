...
<div class="breadcrumb-section breadcrumb-bg-color--golden">
    <div class="breadcrumb-wrapper">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h3 class="breadcrumb-title">Productos Detalle - Iphone 7plus</h3>
                    <div class="breadcrumb-nav breadcrumb-nav-color--black breadcrumb-nav-hover-color--golden">
                        <nav aria-label="breadcrumb">
                            <ul>
                                <li><a href="{{route('home-client')}}">Home</a></li>
                                <li><a href="{{ route('categorias') }}">ecommerce</a></li>
                                <li class="active" aria-current="page">productos Oferta</li>
                            </ul>
                        </nav>
                    </div>
                </div>
                        ...
                        <div class="product-slider-default-1row default-slider-nav-arrow">
                            ...
                            <div
                                ...
                                <div class="swiper-wrapper" id="swiper-wrapper-f172cdf161107c446" aria-live="polite"
                                    ...
                                    <!-- Start Product Default Single Item -->
                                    <div class="product-default-single-item product-color--golden swiper-slide"
                                        role="group" aria-label="5 / 8" style="width: 342.5px; margin-right: 30px;">
                                        <div class="image-box">
                                    ...
                                    <!-- Start Product Default Single Item -->
                                    <div class="product-default-single-item product-color--golden swiper-slide"
                                        role="group" aria-label="6 / 8" style="width: 342.5px; margin-right: 30px;">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                <img src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}"
                                                    alt="">
                                    ...
                                    <!-- Start Product Default Single Item -->
                                    <div class="product-default-single-item product-color--golden swiper-slide"
                                        role="group" aria-label="7 / 8" style="width: 342.5px; margin-right: 30px;">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                <img src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}"
                                                    alt="">
                                    ...
                                    <!-- Start Product Default Single Item -->
                                    <div class="product-default-single-item product-color--golden swiper-slide"
                                        role="group" aria-label="8 / 8" style="width: 342.5px; margin-right: 30px;">
                                        <div class="image-box">
                                            <a href="product-details-default.html" class="image-link">
                                                <img src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}"
                                                    alt="">
