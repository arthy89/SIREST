      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="service-promo-single-item aos-init aos-animate" data-aos="fade-up" data-aos-delay="0">
              <div class="image">
          ...
          <!-- Start Service Promo Single Item -->
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="service-promo-single-item aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
              <div class="image">
          ...
          <!-- Start Service Promo Single Item -->
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="service-promo-single-item aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
              <div class="image">
          ...
          <!-- Start Service Promo Single Item -->
          <div class="col-lg-3 col-sm-6 col-12">
            <div class="service-promo-single-item aos-init aos-animate" data-aos="fade-up" data-aos-delay="600">
              <div class="image">
                    ...
                    <div class="sidebar-single-widget">
                        ...
                        <div class="sidebar-content">
                            <ul class="sidebar-menu">
                                ...
                                <li><a href="#"> Repuesos</a></li>
                                <li><a href="#">servicioti</a></li>
                                <li>
                                    <ul class="sidebar-menu-collapse">
                                        <!-- Start Single Menu Collapse List -->
                                        <li class="sidebar-menu-collapse-list">
                                            <div class="accordion">
                                                <a href="#" class="accordion-title collapsed" data-bs-toggle="collapse" data-bs-target="#men-fashion" aria-expanded="false">mas <i class="ion-ios-arrow-right"></i></a>
                    ...
                    <div class="sidebar-single-widget">
                        <div class="sidebar-content">
                            <a href="product-details-default.html" class="sidebar-banner img-hover-zoom">
                                <img class="img-fluid" src="{{ asset('assetsc/images/product/default/home-3/default-1.jpg') }}" alt="">
                            </a>
                        </div>
                    </div> <!-- End Single Sidebar Widget -->
                                ...
                                <div class="tab-content tab-animate-zoom">
                                    ...
                                    <div class="tab-pane active show sort-layout-single" id="layout-3-grid">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                            ...
                                            <div class="col-xl-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden aos-init" data-aos="fade-up" data-aos-delay="0">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                                            <img src="{{ asset('assetsc/images/product/default/home-3/default-6.jpg') }}"
                                                    alt="" />
                                            ...
                                            <div class="col-xl-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden aos-init" data-aos="fade-up" data-aos-delay="200">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                                            <img src="{{ asset('assetsc/images/product/default/home-3/default-3.jpg') }}"
                                                            alt="" />
                                            ...
                                            <div class="col-xl-4 col-sm-6 col-12">
                                                <!-- Start Product Default Single Item -->
                                                <div class="product-default-single-item product-color--golden aos-init" data-aos="fade-up" data-aos-delay="400">
                                                    <div class="image-box">
                                                        <a href="product-details-default.html" class="image-link">
                                                            <img src="{{ asset('assetsc/images/product/default/home-3/default-3.jpg') }}"
                                                            alt="" />
