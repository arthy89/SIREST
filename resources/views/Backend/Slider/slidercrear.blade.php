                ...
                <div class="card my-4">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <h6 class="text-white text-capitalize ps-3">Nuevo Slider</h6>
                        </div>
                    </div>
                    <div class="card-body">

                        <form action="{{ route('crear_slider') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea  id="htmlcode" name="htmlcode" rows="5" cols="40"><h4 class="subtitle">New collection</h4>
<h1 class="title">New Series of <br>Degital Watch</h1>
<a href="#" class="btn btn-lg btn-pink">ver mas</a>
                                    </textarea>
                                </div>
