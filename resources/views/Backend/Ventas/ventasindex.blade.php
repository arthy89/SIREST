                ...
                <div class="card h-100">
                    <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                        <div class="tab-content shadow-dark border-radius-lg" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade" id="pills-nuevos" role="tabpanel" aria-labelledby="pills-nuevos-tab">
                                <div class="card mb-4 ">
                                    <div class="d-flex">
                                        <div
                                ...
                                <div class="card mb-4 ">
                                    ...
                                    <script>
                                        ...
                                        function sumarCantidad(id) {
                                            ...
                                            //console.log(nuevoId); // Resultado: 1234
                                            actualizarprecio(nuevoId);

                                            //console.log("se sumo en el id : ",id);
                                        }
                    ...
                    <div class="nav-wrapper position-relative end-0">
                        <ul class="nav nav-pills nav-fill p-1" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 active" id="pills-productos-tab" data-bs-toggle="pill"
                            ...
                            <li class="nav-item">
                                <a class="nav-link mb-0 px-0 py-1 " data-bs-toggle="tab" href="#profile-tabs-simple"
                                    role="tab" aria-controls="profile" aria-selected="true" id="pills-nuevos-tab"
                                    data-bs-toggle="pill" data-bs-target="#pills-nuevos" aria-selected="false">Nuevos
