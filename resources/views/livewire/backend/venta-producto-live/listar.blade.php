            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="agregar-carrito">
                        <a  id="" onclick="agregarProducto('{{$producto->idproducto}}', '{{$producto->nombre_p}}','{{$producto->precio_venta_public}}','{{$producto->stock}}' )"
                    ...
                    <td class="align-middle text-center">
                        <span class="text-secondary text-xs font-weight-normal" id="S{{$producto->idproducto}}">{{$producto->stock}} </span><span class="text-secondary text-xs font-weight-normal">und</span>
                    </td>
